        ...
        {{-- <form action="{{ route('your.store.route') }}" method="POST"> --}}
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="text" name="launch_date" class="form-control" data-mask="00/00/0000" placeholder="dd/mm/yyyy">
            </div>

            <!-- Example Phone Mask -->
            <div class="col-md-6 mb-3">
              <label class="font-weight-bold">Contact Number</label>
              <input type="text" name="phone" class="form-control" data-mask="(999) 999-9999" placeholder="(123) 456-7890">
            </div>
